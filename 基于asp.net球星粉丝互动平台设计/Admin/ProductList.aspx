<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductList.aspx.cs" Inherits="chengxusheji.Admin.ProductList" %>
   ...
   <form id="form1" runat="server">
    ...
    <div class="Body_Title">商品管理 》》商品列表</div>
     <div class="Body_Search">
        ...
        宝贝名称&nbsp;&nbsp;<asp:TextBox ID="productName" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        商品状态&nbsp;&nbsp;<asp:TextBox ID="productState" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpProduct" runat="server" onitemcommand="RpProduct_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><%#Eval("productState")%> </td>
                ...
                <td align="center"><a href="ProductEdit.aspx?productId=<%#Eval("productId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("productId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>

   ...
   <form id="form1" runat="server">
    ...
    <div class="Body_Title">用户管理 》》用户列表</div>
     <div class="Body_Search">
        ...
        出生日期&nbsp;&nbsp; <asp:TextBox ID="birthday"  runat="server" Width="112px" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>&nbsp;&nbsp;
        联系电话&nbsp;&nbsp;<asp:TextBox ID="telephone" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        球星标志&nbsp;&nbsp;<asp:TextBox ID="ballStar" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        注册时间&nbsp;&nbsp;<asp:TextBox ID="regTime" runat="server" Width="123px"></asp:TextBox> &nbsp;&nbsp;
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><img src="../<%#Eval("userPhoto")%>" width=50 height=50 />
                  <td align="center"><%# Convert.ToDateTime(Eval("birthday")).ToShortDateString() %></td>
                <td align="center"><%#Eval("telephone")%> </td>
                <td align="center"><%#Eval("ballStar")%> </td>

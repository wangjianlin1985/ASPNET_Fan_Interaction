	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
			...
			<div class="form-group">
				...
				<asp:TextBox ID="birthday"  runat="server" CssClass="form-control" placeholder="请选择出生日期" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="ballStar">球星标志:</label>
				<asp:TextBox ID="ballStar" runat="server"  CssClass="form-control" placeholder="请输入球星标志"></asp:TextBox>
			</div>
			<div class="form-group">
				<label for="regTime">注册时间:</label>
				<asp:TextBox ID="regTime" runat="server"  CssClass="form-control" placeholder="请输入注册时间"></asp:TextBox>
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_ballStar_edit" class="col-md-3 text-right">球星标志:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_ballStar_edit" name="userInfo.ballStar" class="form-control" placeholder="请输入球星标志">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="userInfo_regTime_edit" class="col-md-3 text-right">注册时间:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_regTime_edit" name="userInfo.regTime" class="form-control" placeholder="请输入注册时间">
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_ballStar_edit").val(userInfo.ballStar);

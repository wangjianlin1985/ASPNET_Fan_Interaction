...
public partial class Product_frontList : System.Web.UI.Page
{
    ...
    private void BindproductClassObj()
    {
        ...
        for (int i = 0; i < productClassObjDs.Tables[0].Rows.Count; i++)
        {
            ...
            li = new ListItem(dr["productClassName"].ToString(),dr["producClassId"].ToString());
            productClassObj.Items.Add(li);
        }
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?productClassObj=" + productClassObj.SelectedValue.Trim()+ "&&productName=" + productName.Text.Trim()+ "&&productState=" + productState.Text.Trim() + "&&userObj=" + userObj.SelectedValue.Trim()+ "&&addTime=" + addTime.Text.Trim());
        }

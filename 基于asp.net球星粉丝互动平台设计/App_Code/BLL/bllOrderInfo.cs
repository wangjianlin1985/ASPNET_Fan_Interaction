...
namespace BLL
{
    ...
    public class bllOrderInfo{
        ...
        /*销售方根据条件分页查询订单*/
        public static System.Data.DataTable sellerGetOrderInfo(int NowPage, int PageSize, out int AllPage, out int DataCount, string p)
        {
            return DAL.dalOrderInfo.sellerGetOrderInfo(NowPage, PageSize, out AllPage, out DataCount, p);
        }

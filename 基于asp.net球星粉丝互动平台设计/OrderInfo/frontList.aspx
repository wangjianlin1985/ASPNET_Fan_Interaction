<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frontList.aspx.cs" Inherits="OrderInfo_frontList" %>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>订单编号</td><td>购买商品</td><td>购买用户</td><td>下单时间</td><td>订单状态</td><td>操作</td></tr>
				    					<asp:Repeater ID="RpOrderInfo" runat="server">
 										...
 										<tr>
 											...
 											<td><%#GetOrderStateorderStateObj(Eval("orderStateObj").ToString())%></td>
 											<td>
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
            ...
            <div class="form-group">
            	<label for="productObj_orderId">购买商品：</label>
                <asp:DropDownList ID="productObj" runat="server"  CssClass="form-control" placeholder="请选择购买商品"></asp:DropDownList>
            </div>
            <div class="form-group">
            	<label for="userObj_orderId">购买用户：</label>
                <asp:DropDownList ID="userObj" runat="server"  CssClass="form-control" placeholder="请选择购买用户"></asp:DropDownList>
            </div>
			<div class="form-group">
				<label for="orderTime">下单时间:</label>
				<asp:TextBox ID="orderTime"  runat="server" CssClass="form-control" placeholder="请选择下单时间" onclick="SelectDate(this,'yyyy-MM-dd');"></asp:TextBox>
			</div>
            <div class="form-group">
            	<label for="orderStateObj_orderId">订单状态：</label>
                <asp:DropDownList ID="orderStateObj" runat="server"  CssClass="form-control" placeholder="请选择订单状态"></asp:DropDownList>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="orderInfo_orderId_edit" class="col-md-3 text-right">订单编号:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="orderInfo_orderId_edit" name="orderInfo.orderId" class="form-control" placeholder="请输入订单编号" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="orderInfo_productObj_productId_edit" class="col-md-3 text-right">购买商品:</label>
		  	 <div class="col-md-9">
			    <select id="orderInfo_productObj_productId_edit" name="orderInfo.productObj.productId" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="orderInfo_userObj_user_name_edit" class="col-md-3 text-right">购买用户:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="orderInfo_orderStateObj_stateId_edit" class="col-md-3 text-right">订单状态:</label>
		  	 <div class="col-md-9">
			    <select id="orderInfo_orderStateObj_stateId_edit" name="orderInfo.orderStateObj.stateId" class="form-control">
			    </select>
		  	 </div>
		  </div>
		</form> 
			...
			if (orderInfo) {
				...
				$.ajax({
					...
					success: function(products,response,status) { 
						$("#orderInfo_productObj_productId_edit").empty();
						var html="";
		        		$(products).each(function(i,product){
		        			html += "<option value='" + product.productId + "'>" + product.productName + "</option>";
		        		});
		        		$("#orderInfo_productObj_productId_edit").html(html);
		        		$("#orderInfo_productObj_productId_edit").val(orderInfo.productObjPri);
					}
				});
				$.ajax({
				...
				$.ajax({
					url: basePath + "OrderState/OrderStateController.aspx?action=listAll",
					type: "get",
					dataType: "json",
					success: function(orderStates,response,status) { 
						$("#orderInfo_orderStateObj_stateId_edit").empty();
						var html="";
		        		$(orderStates).each(function(i,orderState){
		        			html += "<option value='" + orderState.stateId + "'>" + orderState.stateName + "</option>";
		        		});
		        		$("#orderInfo_orderStateObj_stateId_edit").html(html);
		        		$("#orderInfo_orderStateObj_stateId_edit").val(orderInfo.orderStateObjPri);
					}
				});

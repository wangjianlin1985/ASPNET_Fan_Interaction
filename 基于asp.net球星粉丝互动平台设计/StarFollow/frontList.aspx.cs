...
using System.Data;
public partial class StarFollow_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?starObj=" + starObj.SelectedValue.Trim() + "&&userObj=" + userObj.SelectedValue.Trim()+ "&&followTime=" + followTime.Text.Trim());
        }

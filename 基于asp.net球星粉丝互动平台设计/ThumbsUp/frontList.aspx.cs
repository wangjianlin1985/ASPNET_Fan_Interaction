...
using System.Data;
public partial class ThumbsUp_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?postInfoObj=" + postInfoObj.SelectedValue.Trim() + "&&userObj=" + userObj.SelectedValue.Trim()+ "&&thumbsUpTime=" + thumbsUpTime.Text.Trim());
        }
